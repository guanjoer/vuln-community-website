	...
	<div class="profile-info">
		<div class="profile-info-2">
			<?php if (isset($_SESSION['user_id'])): ?>
				<img id="profile-preview" src="uploads/<?php echo !empty($user['profile_image']) ? $user['profile_image'] : 'default.png'; ?>" alt="프로필 이미지">
				<span id="username">어서오세요<br><strong><?php echo $user['username']; ?></strong> 님</span>
		</div>
